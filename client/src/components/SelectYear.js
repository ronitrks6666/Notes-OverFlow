  ...
  return (
    <div className='container select-year w-100'>
         ...
         <div className="select-year-content">
             <div className="year-num"><Link to="/note?year=1&sem=1"><img src={oneIcon} className='year-num-img' alt="" /></Link></div>
             <div className="year-num"><Link to="/note?year=2&sem=1"><img src={twoIcon} className='year-num-img' alt="" /></Link></div>
             <div className="year-num"><Link to="/note?year=3&sem=1"><img src={threeIcon} className='year-num-img' alt="" /></Link></div>
             <div className="year-num"><Link to="/note?year=4&sem=1"><img src={fourIcon} className='year-num-img' alt="" /></Link></div>
         </div>
    </div>
  )
}
